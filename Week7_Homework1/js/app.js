...
$(document).ready(function(){
    ...
    var bgSaved = localStorage.getItem("bg");
    ...
    /*加载皮肤*/
    function load(){
        if (bgSaved != undefined) {
            $("body").css("background", "url('"+bgSaved+"') no-repeat fixed");
            $(".hd").addClass("hd-bg");
    ...
    function skin(){
        ...
        $(".skin-list-pic").each(function(index){
            $(this).mouseover(function(){
                $("#preview-content").attr({"src":this.src,"width":264,"height":180});
            });
            $(this).click(function(){
                bgSaved = this.src;
                localStorage.setItem("bg",bgSaved);
